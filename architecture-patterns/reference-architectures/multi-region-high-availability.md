# Multi-Region High Availability
    ...
    A critical service needs continuity during regional disruption.

    ## When To Use This Pattern

    Use it when business RTO/RPO justify replication and operational complexity.

    ## Architecture Explanation

    The pattern uses Global Accelerator, CDN, SLB, ECS or ACK, RDS or PolarDB replication, OSS replication, SLS to separate responsibilities, reduce operational risk, and provide a repeatable design for teams.

    ## Alibaba Cloud Services Used

    Global Accelerator, CDN, SLB, ECS or ACK, RDS or PolarDB replication, OSS replication, SLS

    ## Tradeoffs

    - Higher cost.
- Data consistency and failover complexity.
- Requires regular DR exercises.
