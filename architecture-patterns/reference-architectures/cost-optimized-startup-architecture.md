# Cost-Optimized Startup Architecture
    ...
    A small team needs useful cloud capability with strict spend controls.

    ## When To Use This Pattern

    Use it for MVPs and early-stage workloads.

    ## Architecture Explanation

    The pattern uses OSS, Function Compute, ECS small instances, RDS small edition, CloudMonitor, Budget alerts to separate responsibilities, reduce operational risk, and provide a repeatable design for teams.

    ## Alibaba Cloud Services Used

    OSS, Function Compute, ECS small instances, RDS small edition, CloudMonitor, Budget alerts

    ## Tradeoffs

    - Low initial cost.
- May need redesign at scale.
- Budget alerts and cleanup are critical.
