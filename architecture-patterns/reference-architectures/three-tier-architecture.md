# Three-Tier Architecture
    ...
    Separate presentation, application, and database tiers for maintainability and security.

    ## When To Use This Pattern

    Use it for common business applications with clear web, app, and data layers.

    ## Architecture Explanation

    The pattern uses SLB, ECS, RDS, OSS, VPC, Security groups to separate responsibilities, reduce operational risk, and provide a repeatable design for teams.

    ## Alibaba Cloud Services Used

    SLB, ECS, RDS, OSS, VPC, Security groups

    ## Tradeoffs

    - Familiar pattern.
- May be too rigid for event-driven systems.
- Works well for migration projects.
