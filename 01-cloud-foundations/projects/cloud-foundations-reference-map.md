# Cloud Foundations Reference Map

## Business Scenario

A team needs a practical Alibaba Cloud implementation aligned to the Cloud Foundations.
...
- Designed an Alibaba Cloud solution using Cloud computing vocabulary, IaaS PaaS SaaS, Regions and zones, Shared responsibility, Billing basics with security, monitoring, and cost controls.
