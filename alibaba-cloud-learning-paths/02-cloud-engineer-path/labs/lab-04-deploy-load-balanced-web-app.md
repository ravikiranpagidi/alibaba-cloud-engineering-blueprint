# Deploy Load Balanced Web App

## Objective

Build practical confidence with ECS, OSS, VPC, vSwitch, SLB, Auto Scaling using a guided Alibaba Cloud exercise that includes validation, cleanup, and interview reflection.
