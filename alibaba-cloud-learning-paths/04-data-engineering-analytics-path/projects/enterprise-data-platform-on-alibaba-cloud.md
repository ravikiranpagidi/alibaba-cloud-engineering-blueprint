# Enterprise Data Platform On Alibaba Cloud

## Business Scenario

A team needs a practical Alibaba Cloud implementation aligned to the Data Engineering Analytics Path.
...
- Log Service
- EventBridge or messaging ingestion
- AnalyticDB
- Hologres
- Data Lake Formation
...
- Designed an Alibaba Cloud solution using OSS data lake, DataWorks, MaxCompute, Realtime Compute for Apache Flink, Log Service with security, monitoring, and cost controls.
