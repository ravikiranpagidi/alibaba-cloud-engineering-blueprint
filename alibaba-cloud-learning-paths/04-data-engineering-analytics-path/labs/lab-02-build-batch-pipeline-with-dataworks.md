# Build Batch Pipeline With DataWorks

## Objective

Build practical confidence with OSS data lake, DataWorks, MaxCompute, Realtime Compute for Apache Flink, Log Service, EventBridge or messaging ingestion using a guided Alibaba Cloud exercise that includes validation, cleanup, and interview reflection.
