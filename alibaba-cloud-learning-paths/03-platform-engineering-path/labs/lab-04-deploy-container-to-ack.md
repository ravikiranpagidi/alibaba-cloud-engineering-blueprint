# Deploy Container To ACK

## Objective

Build practical confidence with Alibaba Cloud CLI, Terraform Alibaba Cloud provider, Resource Orchestration Service, ACK, Container Registry, GitHub Actions using a guided Alibaba Cloud exercise that includes validation, cleanup, and interview reflection.
