# Explore Alibaba Cloud Console

## Objective

Build practical confidence with Cloud computing vocabulary, IaaS PaaS SaaS, Regions and zones, Shared responsibility, Billing basics, Basic networking using a guided Alibaba Cloud exercise that includes validation, cleanup, and interview reflection.
