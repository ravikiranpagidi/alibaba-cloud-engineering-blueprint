# Zero-Trust Access Pattern
    ...
    Access must be continuously verified and minimized.

    ## When To Use This Pattern

    Use it for privileged administration, sensitive applications, and regulated environments.

    ## Architecture Explanation

    The pattern uses RAM, MFA, Cloud Firewall, PrivateLink, ActionTrail, KMS, Security Center to separate responsibilities, reduce operational risk, and provide a repeatable design for teams.

    ## Alibaba Cloud Services Used

    RAM, MFA, Cloud Firewall, PrivateLink, ActionTrail, KMS, Security Center

    ## Tradeoffs

    - Strong security posture.
- Requires identity maturity.
- Can slow teams if approvals are manual.
