# Hub-And-Spoke Network
    ...
    Multiple workload networks need shared services and centralized inspection.

    ## When To Use This Pattern

    Use it when many teams or environments need consistent connectivity.

    ## Architecture Explanation

    The pattern uses VPC, CEN, NAT Gateway, Cloud Firewall, VPN Gateway, Express Connect to separate responsibilities, reduce operational risk, and provide a repeatable design for teams.

    ## Alibaba Cloud Services Used

    VPC, CEN, NAT Gateway, Cloud Firewall, VPN Gateway, Express Connect

    ## Tradeoffs

    - Central control.
- Routing complexity.
- Shared hub can become a dependency.
