# Serverless Event-Driven Architecture
    ...
    Teams need event processing without managing servers.

    ## When To Use This Pattern

    Use it for bursty APIs, automation, file processing, and integration workflows.

    ## Architecture Explanation

    The pattern uses Function Compute, EventBridge, API Gateway, OSS, SLS to separate responsibilities, reduce operational risk, and provide a repeatable design for teams.

    ## Alibaba Cloud Services Used

    Function Compute, EventBridge, API Gateway, OSS, SLS

    ## Tradeoffs

    - Low operational overhead.
- Timeout and cold start constraints.
